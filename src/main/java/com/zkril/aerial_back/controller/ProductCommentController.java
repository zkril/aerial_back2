...
public class ProductCommentController {
    ...
    public Result addComment(
        ...
        productCommentsMapper.insert(comment);
    ...
    public Result getComments(
        ...
        List<ProductComments> comments = productCommentsMapper.selectList(
                new QueryWrapper<ProductComments>()
    ...
    public Result likeComment(@RequestParam Integer commentId, @RequestParam Integer userId) {
        ProductComments comment = productCommentsMapper.selectById(commentId);
        ...
        if (!userIdSet.contains(String.valueOf(userId))) {
            ...
            productCommentsMapper.updateById(comment);
        }
    ...
    public Result markRead(@PathVariable Long id) {
        ProductComments comment = productCommentsMapper.selectById(id);
        if (comment != null) {
            comment.setIsread(1);
            productCommentsMapper.updateById(comment);
        }
